...
\begin{DoxyWarning}{Warning}
According to observable contract (\href{https://reactivex.io/documentation/operators/switch.html}{\texttt{ https\+://reactivex.\+io/documentation/operators/switch.\+html}}) emissions from any observable should be serialized, so, resulting observable uses mutex to satisfy this requirement
\end{DoxyWarning}
...
\DoxyCodeLine{\textcolor{comment}{//                        .lift([](rpp::dynamic\_subscriber<int> subscriber) \{}}
\DoxyCodeLine{\textcolor{comment}{//                            subscriber.get\_subscription().add([] \{}}
\DoxyCodeLine{\textcolor{comment}{//                                std::cout << "x-\/"; // x is notation for unsubscribed}}
